...
# @Last Modified time: 2017-05-14 18:40:58
...
'''
This script converts the all the pdfs from the IEEE Xplore website to JSON. These PDFs will be used
as data for the project.
'''
...
if __name__ == '__main__':
  ...
  if not exists('pdf_jsons'):
    makedirs('pdf_jsons')
  if not exists('pdf_grouped_jsons')
    makedirs('pdf_grouped_jsons')
  print('Starting the generation process.., brace yourselves!')
  generate_jsons()
  print('Done generating the jsons!')
